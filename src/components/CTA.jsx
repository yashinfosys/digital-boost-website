      ...
      <div className="mx-auto max-w-7xl overflow-hidden rounded-2xl border border-boost-yellow/30 bg-boost-yellow p-6 text-black shadow-glow sm:p-10">
        <div className="grid items-center gap-6 lg:grid-cols-[1fr_auto]">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <a href={brand.whatsapp} target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 rounded-md bg-white px-5 py-4 text-sm font-black text-black">
